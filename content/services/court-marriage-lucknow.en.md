...
faqs:
  - q: "Is parental consent required for a court marriage?"
    a: "Not legally, for adults who meet the age requirement under the Special Marriage Act. Both parties must be of legal marriageable age and give their own free consent, and the marriage can proceed without parental consent, though family involvement is, of course, a personal choice."
  - q: "What is the total realistic time for a court marriage in Lucknow?"
    a: "The Special Marriage Act requires a statutory notice period of 30 days before solemnization, during which objections, if any, can be raised. Including document preparation and processing at the Marriage Officer's office, couples should generally plan for the notice period plus some additional time for administrative steps."
  - q: "Who can act as a witness for a court marriage?"
    a: "The Act requires three witnesses at the time of solemnization. Witnesses are generally required to be adults with valid identity proof; specific requirements can vary slightly depending on the Marriage Officer's office."
  - q: "Can the notice be given at a Lucknow Marriage Officer's office if I recently moved here?"
    a: "The notice is given to the Marriage Officer of the district where at least one of the parties has resided for a specified period — commonly 30 days — immediately preceding the date of notice. If you have recently moved to Lucknow, this residency requirement needs to be satisfied before notice can be given there."
  - q: "What about registering a marriage that was already solemnized through religious rites?"
    a: "Registration of an already-solemnized marriage is a distinct process from a Special Marriage Act court marriage, governed by separate registration rules, and generally requires different documentation. This should be discussed specifically based on how and where the original marriage was solemnized."
  - q: "What if my family objects to an inter-faith or inter-caste marriage?"
    a: "The Special Marriage Act exists specifically to allow marriage between parties of any religion or caste through a civil process, independent of religious ceremony or family consent. Couples facing safety concerns around family objection should raise this with their advocate early so that appropriate precautions and legal remedies can be discussed alongside the marriage process itself."
---
...
1. **Notice to the Marriage Officer (Section 5).** Either party gives written notice of the intended marriage to the Marriage Officer of the district where at least one party has resided for a specified period — commonly 30 days — immediately before the notice.
2. **30-day notice period.** The notice is published, and a period of 30 days is provided during which any person can raise an objection to the marriage.
3. **Objection window (Section 7).** If an objection is raised within this period, the Marriage Officer inquires into it before deciding whether the marriage can proceed.
4. **Solemnization.** If no objection is raised, or any objection raised is not upheld, the marriage is solemnized before the Marriage Officer in the presence of three witnesses, and a Marriage Certificate is issued.
